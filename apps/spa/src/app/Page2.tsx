import { clientApi } from '@my-apps/client-api';
 ...
 * * * * * * * * * * * * * * * * * * * * * * * * * * * *
 */
export function Page2({ title }: { title: string }) {
	return (
		<>
			<style
					...
					<div id="hero" className="rounded">
						<div className="text-container">
							<h2>
								...
								<span>{`The ${clientApi()} library was successfully implemented with an import alias!`}</span>
							</h2>
